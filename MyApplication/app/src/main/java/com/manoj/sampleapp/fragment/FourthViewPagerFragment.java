...
public class FourthViewPagerFragment extends Fragment {
    ...
    public FourthViewPagerFragment() {
    }


    public static FourthViewPagerFragment getNewInstance(int number) {
        FourthViewPagerFragment fragment = new FourthViewPagerFragment();
